<template>
  <section class="py-12 bg-gray-100">
    <div class="max-w-6xl mx-auto px-4 text-center">
      <h2 class="text-3xl md:text-4xl font-bold mb-8 text-deep-blue mb-6 ">
        Why Choose Us?
      </h2>
      <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="flex flex-col space-y-3">
          <div
            class="w-full flex items-center justify-center text-deep-blue"
          >
            <svg
              aria-hidden="true"
          ...
          <h3 class="text-lg md:text-2xl font-bold text-deep-blue">
            Skilled Technicians
          </h3>
          <p class="text-deep-blue">
            Our certified experts are trained to handle all appliance brands
        ...
        <div class="flex flex-col space-y-3">
          ...
          <p class="text-deep-blue">
            Get your appliances repaired quickly with our convenient same-day
            service option.
          </p>
        </div>
        ...
        <div class="flex flex-col space-y-3">
          ...
          <p class="text-deep-blue">
            Enjoy peace of mind with a manufacturer warranty on all parts we use
            in our repairs.
          </p>
        </div>
        ...
        <div class="flex flex-col space-y-3">
          ...
          <p class="text-deep-blue">
            We service a wide range of brands, ensuring every appliance receives
            expert care.
          </p>
        </div>
      </div>
